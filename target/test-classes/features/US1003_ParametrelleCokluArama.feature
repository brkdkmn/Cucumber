...
@p2
  ...
  Scenario: TC05 Kullanici Parametreli method ile yuzuk aratir

    Given kullanici amazon anasayfaya gider
    Then amazon arama kutusuna "yuzuk" yazip aratir
    And arama sonuclarinin "yuzuk" icerdigini test eder
    And sayfayi kapatir